...
class InitDefault
{
    ...
    public $monsterExp     = [20, 6, 5, 7, 6, 9, 8, 17, 12, 10, 10, 9, 30, 13, 15, 10, 25, 22, 40, 45, 43, 50, 50, 48, 60, 100, 200];
    public $monsterValue   = [1000, 300, 200, 400, 300, 600, 500, 900, 700, 600, 800, 700, 2000, 900, 1000, 300, 1800, 1200, 2500, 3000, 2700, 5000, 4000, 3500, 7000, 10000, 50000];
    // 特殊能力の内容は、(各能力はビット割り当て)
    // 0x00000 特になし
