...
class LogIO
{
     ...
     * @return void
     */
    public function slideBackLogFile()
    {
     ...
     */
    public function logFilePrint($num = 0, $id = 0, $mode = 0)
    {
        global $init;
...
class Log extends LogIO
{
    ...
    // 食料をプレゼント
    public function presentFood($id, $name, $value)
    {
    ...
    // 受賞
    public function prize($id, $name, $pName)
    {
    ...
    // 島の強制削除
    public function deleteIsland($name)
    {
    ...
    public function doNothing($id, $name, $comName)
    {
        // do not out anything
    }
    // 資金足りない
    public function noMoney($id, $name, $comName)
    {
    ...
    // 食料足りない
    public function noFood($id, $name, $comName)
    {
    ...
    // 木材足りない
    public function noWood($id, $name, $comName)
    {
    ...
    // 衛星足りない
    public function NoAny($id, $name, $comName, $str)
    {
    ...
    // 対象地形の種類による失敗
    public function landFail($id, $name, $comName, $kind, $point)
    {
    ...
    // 対象地形の条件による失敗
    public function JoFail($id, $name, $comName, $kind, $point)
    {
    ...
    // 都市の種類による失敗
    public function BokuFail($id, $name, $comName, $kind, $point)
    {
    ...
    // 周りに町がなくて失敗
    public function NoTownAround($id, $name, $comName, $point)
    {
    ...
    // 成功
    public function landSuc($id, $name, $comName, $point)
    {
    ...
    // 倉庫関係
    public function Souko($id, $name, $comName, $point, $str)
    {
    ...
    // 倉庫関係
    public function SoukoMax($id, $name, $comName, $point, $str)
    {
    ...
    // 倉庫関係
    public function SoukoLupin($id, $name, $lName, $point)
    {
    ...
    // 整地系ログまとめ
    public function landSucMatome($id, $name, $comName, $point)
    {
    ...
    // 埋蔵金
    public function maizo($id, $name, $comName, $value)
    {
    ...
    public function noLandAround($id, $name, $comName, $point)
    {
    ...
    // 卵発見
    public function EggFound($id, $name, $comName, $point)
    {
    ...
    // 卵孵化
    public function EggBomb($id, $name, $mName, $point, $lName)
    {
    ...
    // お土産
    public function Miyage($id, $name, $lName, $point, $str)
    {
    ...
    // 収穫
    public function Syukaku($id, $name, $lName, $point, $str)
    {
    ...
    // 銀行化
    public function Bank($id, $name, $lName, $point)
    {
    ...
    // 衛星打ち上げ成功
    public function Eiseisuc($id, $name, $kind, $str)
    {
    ...
    // 衛星撃沈
    public function Eiseifail($id, $name, $comName, $point)
    {
    ...
    // 衛星破壊成功
    public function EiseiAtts($id, $tId, $name, $tName, $comName, $tEiseiname)
    {
    ...
    // 衛星破壊失敗
    public function EiseiAttf($id, $tId, $name, $tName, $comName, $tEiseiname)
    {
    ...
    // 衛星レーザー
    public function EiseiLzr($id, $tId, $name, $tName, $comName, $tLname, $point, $str)
    {
    ...
    // 油田発見
    public function oilFound($id, $name, $point, $comName, $str)
    {
    ...
    // 油田発見ならず
    public function oilFail($id, $name, $point, $comName, $str)
    {
    ...
    // 防衛施設、自爆セット
    public function bombSet($id, $name, $lName, $point)
    {
    ...
    // 防衛施設、自爆作動
    public function bombFire($id, $name, $lName, $point)
    {
    ...
    // メルトダウン発生
    public function CrushElector($id, $name, $lName, $point)
    {
    ...
    // 停電発生
    public function Teiden($id, $name)
    {
    ...
    // 日照り発生
    public function Hideri($id, $name)
    {
    ...
    // にわか雨発生
    public function Niwakaame($id, $name)
    {
    ...
    // 植林orミサイル基地
    public function PBSuc($id, $name, $comName, $point)
    {
    ...
    // ハリボテ
    public function hariSuc($id, $name, $comName, $comName2, $point)
    {
        $this->secret("<A href=\"{$this->this_file}?Sight={$id}\">{$this->init->tagName_}{$name}{$this->init->nameSuffix}</A>{$point}{$this->init->_tagName}で{$this->init->tagComName_}{$comName}{$this->init->_tagComName}が行われました。", $id);
        $this->landSuc($id, $name, $comName2, $point);
    }
    // 記念碑、発射
    public function monFly($id, $name, $lName, $point)
    {
    ...
    // 電力不足
    public function Enehusoku($id, $name, $comName)
    {
    ...
    // ミサイル撃とうとしたが天気が悪い
    public function msNoTenki($id, $name, $comName)
    {
    ...
    public function msNoTarget($id, $name, $comName)
    {
    ...
    // ミサイル撃とうとしたが基地がない
    public function msNoBase($id, $name, $comName)
    {
    ...
    public function msMaxOver($id, $name, $comName)
    {
    ...
    // ステルスミサイルログ
    public function mslogS($id, $tId, $name, $tName, $comName, $point, $missiles, $missileA, $missileB, $missileC, $missileD, $missileE)
    {
    ...
    // その他ミサイルログ
    public function mslog($id, $tId, $name, $tName, $comName, $point, $missiles, $missileA, $missileB, $missileC, $missileD, $missileE)
    {
        $missileBE = $missileB + $missileE;
        $missileH = $missiles - $missileA - $missileC - $missileBE;
    ...
    // 陸地破壊弾、山に命中
    public function msLDMountain($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に命中。<strong>{$tLname}</strong>は消し飛び、荒地と化しました。", $id, $tId);
    }
    // 陸地破壊弾、海底基地に命中
    public function msLDSbase($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}に着水後爆発、同地点にあった<strong>{$tLname}</strong>は跡形もなく吹き飛びました。", $id, $tId);
    }
    // 陸地破壊弾、怪獣に命中
    public function msLDMonster($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}に着弾し爆発。陸地は<strong>怪獣{$tLname}</strong>もろとも水没しました。", $id, $tId);
    }
    // 陸地破壊弾、浅瀬に命中
    public function msLDSea1($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着弾。海底がえぐられました。", $id, $tId);
    }
    // 陸地破壊弾、その他の地形に命中
    public function msLDLand($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着弾。陸地は水没しました。", $id, $tId);
    }
    // 地形隆起弾、海底基地に命中
    public function msLUSbase($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}に着水後爆発、同地点にあった<strong>{$tLname}</strong>は浅瀬に埋まりました。", $id, $tId);
    }
    // 地形隆起弾、深い海に命中
    public function msLUSea0($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着水。海底が隆起し浅瀬となりました。", $id, $tId);
    }
    // 地形隆起弾、浅瀬に命中
    public function msLUSea1($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着弾。海底が隆起し荒地となりました。", $id, $tId);
    }
    // 地形隆起弾、怪獣に命中
    public function msLUMonster($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}に着弾。陸地は隆起し山となり、<strong>怪獣{$tLname}</strong>は生埋めとなりました。", $id, $tId);
    }
    // 地形隆起弾、その他の地形に命中
    public function msLULand($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着弾。陸地は隆起し山となりました。", $id, $tId);
    }
    // バイオミサイル着弾、汚染
    public function msPollution($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>{$tLname}</strong>に着弾。一帯が汚染されました。", $id, $tId);
    }
    // ステルスミサイル、怪獣に命中、硬化中にて無傷
    public function msMonNoDamageS($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    public function msMonNoDamage($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>怪獣{$tLname}</strong>に命中、しかし硬化状態だったため効果がありませんでした。", $id, $tId);
    }
    // ステルスミサイル撃ったが怪獣に叩き落とされる
    public function msMonsCaughtS($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    public function msMonsCaught($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>怪獣{$tLname}</strong>に叩き落とされました。", $id, $tId);
    }
    // ステルスミサイル、怪獣に命中、殺傷
    public function msMonsKillS($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    // 通常ミサイル、怪獣に命中、殺傷
    public function msMonsKill($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>怪獣{$tLname}</strong>に命中。<strong>怪獣{$tLname}</strong>は力尽き、倒れました。", $id, $tId);
    }
    // 怪獣の死体（ステルス）
    public function msMonMoneyS($id, $tId, $tLname, $value)
    {
    ...
    // 怪獣の死体（通常）
    public function msMonMoney($id, $tId, $tLname, $value)
    {
        $this->out("-<strong>怪獣{$tLname}</strong>の残骸には、<strong>{$value}{$this->init->unitMoney}</strong>の値が付きました。", $id, $tId);
    }
    // ステルスミサイル、怪獣に命中、ダメージ
    public function msMonsterS($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    // バイオミサイル、怪獣に命中、突然変異
    public function msMutation($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
        $this->out("-{$tPoint}の<strong>怪獣{$tLname}</strong>に命中。<strong>怪獣{$tLname}</strong>に突然変異が生じました。", $id, $tId);
    }
    // 催眠弾が怪獣に命中
    public function MsSleeper($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    // 睡眠中の怪獣にミサイル命中
    public function MsWakeup($id, $tId, $name, $tName, $comName, $tLname, $point, $tPoint)
    {
    ...
    // 睡眠中の怪獣が目覚める
    public function MonsWakeup($id, $name, $lName, $point, $mName)
    {
    ...
    // ミサイル難民到着
    public function msBoatPeople($id, $name, $achive)
    {
    ...
    // 怪獣派遣
    public function monsSend($id, $tId, $name, $tName)
    {
    ...
    // 衛星消滅？！
    public function EiseiEnd($id, $name, $tEiseiname)
    {
    ...
    // 怪獣輸送
    public function monsSendSleeper($id, $tId, $name, $tName, $lName)
    {
    ...
    // 輸出
    public function sell($id, $name, $comName, $value, $unit)
    {
    ...
    // 援助
    public function aid($id, $tId, $name, $tName, $comName, $str)
    {
    ...
    // 誘致活動
    public function propaganda($id, $name, $comName)
    {
        $this->out("<A href=\"{$this->this_file}?Sight={$id}\">{$this->init->tagName_}{$name}{$this->init->nameSuffix}</A>{$this->init->_tagName}で{$this->init->tagComName_}{$comName}{$this->init->_tagComName}が行われました。", $id);
    }
    // 放棄
    public function giveup($id, $name)
    {
    ...
    // 油田からの収入
    public function oilMoney($id, $name, $lName, $point, $str)
    {
    ...
    // 油田枯渇
    public function oilEnd($id, $name, $lName, $point)
    {
    ...
    // 宝くじ購入
    public function buyLot($id, $name, $comName, $str)
    {
    ...
    // 宝くじ完売
    public function noLot($id, $name, $comName)
    {
    ...
    // 宝くじ収入
    public function LotteryMoney($id, $name, $str, $syo)
    {
    ...
    // 宝くじはずれ
    public function LotteryBlank($id, $name)
    {
    ...
    // 遊園地からの収入
    public function ParkMoney($id, $name, $lName, $point, $str)
    {
    ...
    // 遊園地のイベント
    public function ParkEvent($id, $name, $lName, $point, $str)
    {
    ...
    // 遊園地のイベント増収
    public function ParkEventLuck($id, $name, $lName, $point, $str)
    {
    ...
    // 遊園地のイベント減収
    public function ParkEventLoss($id, $name, $lName, $point, $str)
    {
    ...
    // 遊園地が閉園
    public function ParkEnd($id, $name, $lName, $point)
    {
    ...
    // 怪獣、防衛施設を踏む
    public function monsMoveDefence($id, $name, $lName, $point, $mName)
    {
    ...
    // 怪獣が自爆する
    public function MonsExplosion($id, $name, $point, $mName)
    {
    ...
    // 怪獣分裂
    public function monsBunretu($id, $name, $lName, $point, $mName)
    {
    ...
    // 怪獣動く
    public function monsMove($id, $name, $lName, $point, $mName)
    {
    ...
    // ぞらす動く
    public function ZorasuMove($id, $name, $lName, $point)
    {
    ...
    // 火災
    public function fire($id, $name, $lName, $point)
    {
    ...
    // 火災未遂
    public function firenot($id, $name, $lName, $point)
    {
    ...
    // 広域被害、海の建設
    public function wideDamageSea2($id, $name, $lName, $point)
    {
    ...
    // 広域被害、怪獣水没
    public function wideDamageMonsterSea($id, $name, $lName, $point)
    {
    ...
    // 広域被害、水没
    public function wideDamageSea($id, $name, $lName, $point)
    {
    ...
    // 広域被害、怪獣
    public function wideDamageMonster($id, $name, $lName, $point)
    {
    ...
    // 広域被害、荒地
    public function wideDamageWaste($id, $name, $lName, $point)
    {
    ...
    // 地震発生
    public function earthquake($id, $name)
    {
    ...
    // 地震被害
    public function eQDamage($id, $name, $lName, $point)
    {
    ...
    // 地震被害未遂
    public function eQDamagenot($id, $name, $lName, $point)
    {
    ...
    // 飢餓
    public function starve($id, $name)
    {
    ...
    // 暴動発生
    public function pooriot($id, $name)
    {
    ...
    // 暴動被害（人口減）
    public function riotDamage1($id, $name, $lName, $point)
    {
    ...
    // 暴動被害（壊滅）
    public function riotDamage2($id, $name, $lName, $point)
    {
    ...
    // 食料不足被害
    public function svDamage($id, $name, $lName, $point)
    {
    ...
    // 津波被害
    public function tsunamiDamage($id, $name, $lName, $point)
    {
    ...
    // 船帰還した
    public function shipReturn($id, $tId, $name, $sName, $point, $tName)
    {
    ...
    // 財宝回収
    public function RecoveryTreasure($id, $name, $sName, $value)
    {
    ...
    // 船失敗
    public function shipFail($id, $name, $comName, $kind)
    {
    ...
    // ぞらす現る
    public function ZorasuCome($id, $name, $point)
    {
    ...
    // 怪獣呼ばれる
    public function monsCall($id, $name, $mName, $point)
    {
    ...
    // 怪獣ワープ
    public function monsWarp($id, $tId, $name, $mName, $point, $tName)
    {
    ...
    // 怪獣による資金増加
    public function MonsMoney($id, $name, $mName, $point, $str)
    {
    ...
    // 怪獣による食料増加
    public function MonsFood($id, $name, $mName, $point, $str)
    {
    ...
    // 地盤沈下発生
    public function falldown($id, $name)
    {
    ...
    // 地盤沈下被害
    public function falldownLand($id, $name, $lName, $point)
    {
    ...
    // 台風発生
    public function typhoon($id, $name)
    {
    ...
    // 台風被害
    public function typhoonDamage($id, $name, $lName, $point)
    {
    ...
    // ストライキ
    public function Sto($id, $name, $lName, $point)
    {
    ...
    // 隕石、その他
    public function hugeMeteo($id, $name, $point)
    {
    ...
    // 記念碑、落下
    public function monDamage($id, $name, $point)
    {
    ...
    // 家族の力
    public function kazokuPower($id, $name, $power)
    {
    ...
    // 隕石、海
    public function meteoSea($id, $name, $lName, $point)
    {
    ...
    // 隕石、山
    public function meteoMountain($id, $name, $lName, $point)
    {
    ...
    // 隕石、海底基地
    public function meteoSbase($id, $name, $lName, $point)
    {
    ...
    // 隕石、怪獣
    public function meteoMonster($id, $name, $lName, $point)
    {
    ...
    // 隕石、浅瀬
    public function meteoSea1($id, $name, $lName, $point)
    {
    ...
    // 隕石、その他
    public function meteoNormal($id, $name, $lName, $point)
    {
    ...
    // 噴火
    public function eruption($id, $name, $lName, $point)
    {
    ...
    // 噴火、浅瀬
    public function eruptionSea1($id, $name, $lName, $point)
    {
    ...
    // 噴火、海or海基
    public function eruptionSea($id, $name, $lName, $point)
    {
    ...
    // 噴火、その他
    public function eruptionNormal($id, $name, $lName, $point)
    {
    ...
    // 海底探索の油田
    public function tansakuoil($id, $name, $lName, $point)
    {
    ...
    // 周りに海がなくて失敗
    public function NoSeaAround($id, $name, $comName, $point)
    {
    ...
    // 周りに浅瀬がなくて失敗
    public function NoShoalAround($id, $name, $comName, $point)
    {
    ...
    // 海がなくて失敗
    public function NoSea($id, $name, $comName, $point)
    {
    ...
    // 船の最大所有数
    public function maxShip($id, $name, $comName, $point)
    {
    ...
    // 海賊船現る
    public function VikingCome($id, $name, $point)
    {
    ...
    // 海賊船去る
    public function VikingAway($id, $name, $point)
    {
    ...
    // 海賊船攻撃
    public function VikingAttack($id, $tId, $name, $tName, $lName, $point, $tPoint, $tshipName)
    {
    ...
    // 戦艦攻撃
    public function SenkanAttack($id, $tId, $name, $tName, $lName, $point, $tpoint, $tshipName)
    {
    ...
    // 海戦沈没
    public function BattleSinking($id, $tId, $name, $lName, $point)
    {
    ...
    // 船舶沈没
    public function ShipSinking($id, $tId, $name, $tName, $lName, $point)
    {
    ...
    // 海賊船の財宝
    public function VikingTreasure($id, $name, $point)
    {
    ...
    // 財宝発見
    public function FindTreasure($id, $tId, $name, $tName, $point, $tshipName, $value)
    {
    ...
    // 海賊船、強奪
    public function RobViking($id, $name, $point, $tshipName, $money, $food)
    {
    ...
    // 船座礁
    public function RunAground($id, $name, $lName, $point)
    {
    ...
    // 戦艦ステルスミサイル迎撃
    public function msInterceptS($id, $tId, $name, $tName, $comName, $point, $missileE)
    {
    ...
    // 戦艦通常ミサイル迎撃
    public function msIntercept($id, $tId, $name, $tName, $comName, $point, $missileE)
    {
        $this->out("-{$this->init->tagName_}{$missileE}発{$this->init->_tagName}は<strong>戦艦</strong>によって迎撃されたようです。", $id, $tId);
    }
    // アイテム探索ログ開始
    // アイテム発見
    public function ItemFound($id, $name, $comName, $point)
    {
    ...
    // マスターソード発見
    public function SwordFound($id, $name, $mName)
    {
    ...
    // レッドダイヤ発見
    public function RedFound($id, $name, $point)
    {
    ...
    // ジン発見
    public function ZinFound($id, $name, $comName, $point)
    {
    ...
    // ウィスプ発見
    public function Zin3Found($id, $name, $comName, $point)
    {
    ...
    // ルナ発見
    public function Zin5Found($id, $name, $comName, $point)
    {
    ...
    // ジン発見
    public function Zin6Found($id, $name, $comName, $point)
    {
    ...
    // すでにある
    public function IsFail($id, $name, $comName, $land)
    {
    ...
    // サッカー成功
    public function SoccerSuc($id, $name, $comName)
    {
    ...
    // サッカー失敗
    public function SoccerFail($id, $name, $comName)
    {
    ...
    // サッカー失敗2
    public function SoccerFail2($id, $name, $comName)
    {
    ...
    // 試合失敗
    public function GameFail($id, $name, $comName)
    {
    ...
    // 試合勝利
    public function GameWin($id, $tId, $name, $tName, $comName, $it, $tt)
    {
    ...
    // 試合敗退
    public function GameLose($id, $tId, $name, $tName, $comName, $it, $tt)
    {
    ...
    // 試合引き分け
    public function GameDraw($id, $tId, $name, $tName, $comName, $it, $tt)
    {
