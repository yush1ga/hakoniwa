    ...
    <div class="ui container">
        <div class="ui stackable inverted divided equal height stackable grid">
            <div class="eight wide column">
                <h4>Main menu</h4>
                <p><a href="<?= $init->baseDir ?>/hako-admin.php" class="ui small label"><i class="cog icon"></i> 管理画面</a></p>
            </div>
            <div class="eight wide column">
                <p>
                    "<?= $init->title ?>" being managed by <a href="<?= $init->admin_address ?>" target="_blank"><?= $init->admin_name ?>（<?= $init->admin_address ?>）</a>.<?=$processing_time?></p>
                <section id="©">
