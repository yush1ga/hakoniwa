...
<link rel="stylesheet" type="text/css" href="<?=$init->baseDir?>/public/assets/css/style.css">
<style type="text/css">body{background-color:#dadada;}.column{max-width:88vw;}</style>
<?=$opt?>
</head>
